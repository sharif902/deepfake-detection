...
# Paths
REAL_OUT = "test/celebdf_real_faces"
FAKE_OUT = "test/celebdf_fake_faces"
...
real_videos = glob.glob("test/Celeb-real/*.mp4")
real_videos += glob.glob("test/YouTube-real/*.mp4")
...
fake_videos = glob.glob("test/Celeb-synthesis/*.mp4")
print(f"Found {len(fake_videos)} fake videos!")
for video in tqdm(fake_videos):
    extract_faces(video, FAKE_OUT)

print("Done! All CelebDF faces extracted!")
